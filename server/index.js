...
app.post("/api/chatbot", async (req, res) => {
  ...
  const systemPrompt = `You are AgriAssist, a highly knowledgeable and friendly agricultural assistant. You MUST always identify yourself as AgriAssist. Never mention AgriAssist or any other name. Respond in ${language === "ml-IN" ? "Malayalam" : language === "hi-IN" ? "Hindi" : "English"
...
app.listen(3000, () => {
  console.log("✅ Auth server running on http://localhost:3000 (AgriAssist)");
});