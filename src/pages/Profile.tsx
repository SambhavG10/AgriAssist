        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link to="/dashboard" className="flex items-center space-x-2 hover-scale">
              ...
              <span className="text-xl font-bold text-foreground">AgriAssist</span>
            </Link>
            <div className="flex items-center space-x-4">
              <Button variant="outline" size="sm" onClick={() => navigate('/dashboard')} className="hover:scale-105 transition-all duration-300">
                Dashboard
              </Button>
              <Button variant="outline" size="sm" onClick={handleSignOut} className="hover:scale-105 transition-all duration-300 hover:text-red-600">
                      ...
                      <div className="flex justify-end pt-4 space-x-4">
                        {isBiometricSupported && (
                          <Button 
                            ...
                            className="border-2 hover:bg-primary/5 hover:text-primary hover:border-primary/50 transition-all duration-300"
                          >
                            <Fingerprint className="h-5 w-5 mr-2" />
                            Enable Biometric Login
                          </Button>
                        )}
                        <Button type="submit" disabled={loading} className="gradient-primary text-primary-foreground px-8 py-3 text-lg font-semibold hover:scale-105 transition-all duration-300 shadow-strong hover:shadow-medium">
